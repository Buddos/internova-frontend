        ...
        <div className="border-b border-border bg-card px-4 sm:px-6 py-6 sm:py-8">
          ...
          <div className="mt-4 flex flex-col sm:flex-row items-stretch gap-3">
            <div className="flex flex-1 items-center gap-2 rounded-md border border-border bg-background px-3 sm:px-4 py-2 sm:py-2.5">
              ...
              <input placeholder="Search roles, companies, keywords" className="flex-1 min-w-0 bg-transparent text-xs sm:text-sm outline-none placeholder:text-muted-foreground" />
            </div>
            <Button size="lg" className="text-xs sm:text-sm whitespace-nowrap">Search</Button>
          </div>
                  ...
                  <div className="p-4 sm:p-5 flex flex-col flex-1">
                    ...
                    <div className="mt-3 flex flex-wrap gap-1.5">
                      <span className="flex items-center gap-1 rounded-md border border-border px-2 py-0.5 text-xs text-muted-foreground">
                        <MapPin size={12} className="flex-shrink-0" /> {v.location}
                      </span>
                      <span className="flex items-center gap-1 rounded-md border border-border px-2 py-0.5 text-xs text-muted-foreground">
                        <Clock size={12} className="flex-shrink-0" /> {v.duration}
                      </span>
                      <span className="flex items-center gap-1 rounded-md border border-border px-2 py-0.5 text-xs text-muted-foreground">
                        <Briefcase size={12} className="flex-shrink-0" /> {v.type}
                      </span>
                    </div>
                    {/* AI Match Badge */}
                    <div className="mt-3">
                    ...
                    <div className="mt-4 flex items-center justify-between gap-2">
                      <span className="text-xs text-muted-foreground whitespace-nowrap">{v.posted}</span>
                      {hasApplied(v.id) ? (
